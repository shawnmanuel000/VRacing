...
bool test2() {
  Quaternion q = Quaternion(2.3, 1.2, 2.1, 3.0);
  Quaternion qExp = Quaternion(0.512505, 0.267394, 0.467939, 0.668485);
  q.normalize();
...
/* setFromAngleAxis() */
bool test4() {
  Quaternion q0 = Quaternion().setFromAngleAxis(2, 1 / sqrt(14), 2 / sqrt(14), 3 / sqrt(14));
  Quaternion qExp = Quaternion(0.999848, 0.004664, 0.009329, 0.013993);
...
bool test5() {
  ...
  Quaternion qExp = Quaternion(0.723587, 0.373672, -0.482177, 0.322949);
...
bool test6() {
  ...
  Quaternion qExp = Quaternion(0.512505, -0.145908, 0.750596, -0.390712);
  Serial.println("Expected multiplied quaternion:");
  qExp.serialPrint();
  Serial.println("Your result: ");
  q5.serialPrint();
...
void testMain() {
  ...
  int res = test1() + test2() + test3() + test4() + test5() + test6();
