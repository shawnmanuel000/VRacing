...
private:
  ...
  uint8_t I2CreadByte(uint8_t address, uint8_t readRegister);

  /* adjustment value for magnetometer */
  double _magnetometerAdjustmentScaleX, _magnetometerAdjustmentScaleY, _magnetometerAdjustmentScaleZ;
